...
/**Convert the money based on the input
  amount : amount of money
  to : conversion to the new currency
  from: conversion from the current currency
*/
...
/**While waiting the new currency, display a loading text*/
